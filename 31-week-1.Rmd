...
The students should share thee concept maps of the their academic conversations.

If they don't have it, ask them why (given the pros and cons) they don't have it.
...
notes, diagrams, *concept maps*, mind maps, etc; whatever works for you
and is intelligible to your colleagues).

I have highlighted concept maps as they are a powerful way to deepen your
understanding of the topics at hand. As with  _learning journals_,  _concept
maps_ foster reflexivity
[@hibbert_2010_reflexivityrecursionrelationality], an important
characteristic of those who aspire to be qualitative researchers.

(ref:foo) An example concept map --- Source: [Wikipedia](https://upload.wikimedia.org/wikipedia/commons/d/df/Conceptmap.png "Concept Map from Wikipedia")

1. Get to grips with concept mapping? --- 90 minutes 

	- A concept map is a diagram that shows 'ideas' and the
      relationship between those ideas. An example of a concept map is
      shown in Figure \@ref(fig:exampleCM).


	```{r exampleCM, fig.show='hold', fig.cap='(ref:foo)', echo=FALSE}

	knitr::include_graphics('images/ConceptMap.png')

	```

	- Novak is often cited as the orginator of concept maps [for
      example, @novak_2006_originsconceptmapping]. Read his [paper on
      concept maps](https://msu.edu/~luckie/ctools/).
	
	- Now produce a concept map showing the uses of concept maps together
      with the pros and cons of concept mapping.


2. Review "Choosing an academic home"
...
3. Read "Part I" and "Part 2" of Myers
  [-@myers_2013_qualitativeresearchbusiness p. 3--56] --- 120
  minutes.

  - *Summarise* the 'big ideas' that underpin Chapter 2 of the
  ...
  - *Compare and contrast* the role of philosophic assumptions as
	...
	Huff [-@huff_2009_designingresearchpublication] --- 40
	minutes.

4. The University of Auckland has a processes and policies around
   ...
   participants"
   [@theuniversityofauckland_2013_guidingprinciplesconducting] ---
   40 minutes.
...
5. Ahead of doing your learning journal you should read both Daudelin
   [-@daudelin_1996_learningexperiencereflection] and Payne & Payne
   [-@payne_2004_reflexivity] --- 30 minutes.
...
your allocated learning journals of you peers (Section \@ref(ass1)
&dash; 60 minutes).
...
```{theorem, echo=FALSE}
In terms of it being positivist (yes, one can do positivist qualitative research; see chapter 1 of the 4th edition of The SAGE Handbook of Qualitative Research [@denzin_2011_sagehandbookqualitative]), interpretivist, critical, or something else?
...
1. Read chapter 9 of Huff [-@huff_2009_designingresearchpublication]
   ...
   - *Identify* the likely types of goals when using interviews, for
     positivist, interpretivist, and critical research --- 40
     minutes.


2. Read the start of "Part IV" of Myers
  [-@myers_2013_qualitativeresearchbusiness p. 117--135] --- 60 minutes.
...
3. *Develop* a script [-@myers_2013_qualitativeresearchbusiness p. 129]
   ...
   critical forms of research" --- 30 minutes.
...
5. Explore the 'little blue books' at SAGE research methods site
   ...
   - Select one book that focuses on interviewing; spend an hour skim
     reading, and then *summarise* the book --- 90 minutes.
