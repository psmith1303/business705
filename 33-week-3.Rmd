...
perhaps the most prevalent method for doing research. However, it is
important not to be side-tracked by the use of cases in teaching
...
reigns supreme. So, I perhaps over estimate its importance;
nevertheless it is a very important methodology. So this week, you
will undertake the first steps toward doing a research case study;
...
2. Given your ontological/epistemological position, draw a concept map
...
3. Select an empirically-based journal article you have enjoyed (it
...
with masters and PhD students about their qualitative research plans,
we often end up doubling or tripling the amount of time they set aside
to do analysis.
...
* Is thematic analysis more of a top-down or bottom-up
  approach?
...
4. Sign-up for a free account at [Dedoose](http://dedoose.com). Spend
   some time getting familiar with this QDA software by doing thematic analysis and coding the text
