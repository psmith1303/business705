...
What about doing action reseach at scale; e.g., the NHS with 1.7m employees.
```
...
2. Go to the SAGE Research Methods website
   ...
   - *Identify* one of the texts that you think would be helpful to
     you if you were to do action research as part of a year long
     thesis (you may need to make and state, some assumptions).
     Summarise your reasons for you choice, and be prepared to share
     it with your colleagues --- 30 minutes.
   
3. Beyond that, review the video by Prof Danny Burns on Action
   Research on [YouTube](https://www.youtube.com/watch?v=tnnfWuud7J8)
   --- 30 minutes.

   - *Describe* the biggest difference between Prof Burns's 'take' on
     action research compared to Myers
     [-@myers_2013_qualitativeresearchbusiness] --- 10 minutes.
	 
   - *Evaluate* the academic standing of Prof Burns to talk about
     Action Research --- 20 minutes.
	 
   - *Draft* an approach for doing action research at scale, say,
...
2. Read the chapter in 'Social research: Theory, methods and
   ...
   - Based on the two readings, draw a concept map of the main
     concepts and their relationship --- 30 minutes.
...
5. Lookup the term "Going native" in the Dictionary of Statistics &
...
6. Myers [-@myers_2013_qualitativeresearchbusiness], in discussing about
