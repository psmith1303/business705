...
* Looking back, what type of coding did you employ when you first
  tried to do thematic analysis of Appendix \@ref(engineering) (e.g.,
...
1. Read Chapter 9 of Myers [-@myers_2013_qualitativeresearchbusiness
  p. 209--220] to get an overview on Grounded Theory &mdash; 30
  minutes.
...
2. For the leading two or three journals in your own field, say,
   ...
   used. Be prepared to report back on your findings &mdash; 30 minutes
...
3. Visit the SAGE Research methods website: read chapters 1--3 and
   ...
   grounded theory &mdash 210 minutes.
...
5. Using whichever QDA tool you feel most comfortable with, go back to
   Appendix \@ref(engineering) and try open coding it &mdash; 30
   minutes.

6. Return to the 'discussion' on StackExchange Academia on work-life
   ...
   academics and work-life balance? &mdash; 120 minutes.
...
1. Read the paper by Gioia and his co-authors on the 'Gioia method'
   [@gioia_2013_seekingqualitativerigor] &mdash; 30 minutes.

2. Draw a concept map linking the key tenets of the Gioia method to
   grounded theory? &mdash; 15 minutes.
   
3. Review the article by Gioia and Thomas
   [-@gioia_1996_identityimageissue]&mdash;it one of Gioia's exemplars
   ...
   How closely do Gioia and Thomas follow the Gioia method? &mdash 45
   minutes.
...
3. The paper by Anand et al.
   ...
   evaluate how close it follows Gioia's method &mdash 45 minutes.
...
4. For a third time, return to the 'discussion' on StackExchange
   ...
   [-@gioia_2013_seekingqualitativerigor] &mdash; 120 minutes.
