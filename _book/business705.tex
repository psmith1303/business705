...
toolbar at the top of the screen. Something like this:

\begin{figure}
\centering
\includegraphics{images/toolbar.png}
\caption{warning}
\end{figure}
...
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright
17:00 on Thursday (weeks 1--5) Via canvas\strut
\end{minipage} & \begin{minipage}[t]{0.14\columnwidth}\raggedright
25 \%\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.04\columnwidth}\raggedright
...
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright
17:00 on Friday (weeks 1--5) Via canvas\strut
\end{minipage} & \begin{minipage}[t]{0.14\columnwidth}\raggedright
15 \%\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.04\columnwidth}\raggedright
...
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright
17:00 on 1 September Via canvas\strut
\end{minipage} & \begin{minipage}[t]{0.14\columnwidth}\raggedright
50 \%\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.04\columnwidth}\raggedright
...
\item
  be proficient in use tools and techniques to collect qualitative data;
\item
  be proficient in use tools and techniques to analyse qualitative data;
\item
  effectively communicate the findings arising from the collection and
  analysis of qualitative data;
\item
  describe how the choices you make around the collection, analysis, and
  presentation of qualitative data is congruent with your chosen
  research conversation;
\item
  evaluate the quality of qualitatively-based research methods; while,
\item
  employing the tools and techniques of qualitative research methods in
...
You are to maintain a weekly learning journal. Later, you are to use the
your weekly journal as the `data' for a
\protect\hyperlink{ass4}{summative learning journal}/essay on your major
...
more grist you will have for your \protect\hyperlink{ass4}{summative
learning journal}.
...
making to your thinking and behaviour.
...
\item
  ...
  substantively addressing a real issue). My assumption is that this is
  partly because people aren't drawing on particular theory to address a
...
write 10 sets of feedback. Your primary goal in providing feedback is to
...
\item
  ...
  journal. You should correctly cite your weekly learning journal using
  an APA formatted references.
\item
...
20 hours per week on course related activities. My office is in room
...
\begin{figure}
\centering
\includegraphics{images/Huff-2009-fig5.1.pdf}
\caption{\label{fig:huff51}Design decisions connecting research purpose and
outcomes \autocite[ p.~86]{huff_2009_designingresearchpublication}.}
\end{figure}
...
\item
  Write your weekly learning journal
\item
...
mind maps, etc; whatever works for you and is intelligible to your
colleagues).
...
\hypertarget{end-of-week}{%
\section*{End of week}\label{end-of-week}}
\addcontentsline{toc}{section}{End of week}

With the week's classes behind you, it is time to do your learning
journal (Section \ref{ass1} ‐ 60 minutes) and then do your review the
learning journals of your peers (Section \ref{ass1} ‐ 60 minutes).
...
\hypertarget{end-of-week-1}{%
\section*{End of week}\label{end-of-week-1}}
\addcontentsline{toc}{section}{End of week}
...
\hypertarget{end-of-week-2}{%
\section*{End of week}\label{end-of-week-2}}
\addcontentsline{toc}{section}{End of week}
...
\hypertarget{end-of-week-3}{%
\section*{End of week}\label{end-of-week-3}}
\addcontentsline{toc}{section}{End of week}
...
\hypertarget{end-of-week-4}{%
\section*{End of week}\label{end-of-week-4}}
\addcontentsline{toc}{section}{End of week}

With the week's classes behind you, it is time to do your learning
journal (60 minutes) and then review the learning journals of your peers
(60 minutes).
...
\hypertarget{end-of-week-5}{%
\section*{End of week}\label{end-of-week-5}}
\addcontentsline{toc}{section}{End of week}
...
A Postgraduate Research Graduate (ie, masters level or equivalent) will
demonstrate welldeveloped skills in the definition, management, and
communication of research in a specialist area. On completing their
studies at a satisfactory level, Postgraduate Research Graduates will
have attained a core set of attributes and values that provide a
platform to allow them: (i) to undertake advanced and original research
at the doctoral level in their chosen subject field; (ii) to continue
developing personally and professionally in their careers; and (iii) to
make potentially innovative, and important contributions to the
communities and societies in which they reside. The University of
Auckland expects its Postgraduate Research Graduates to obtain the
following attributes and values:

\hypertarget{specialist-knowledge}{%
\subsection{Specialist knowledge}\label{specialist-knowledge}}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  A mastery of a body of knowledge, including a high level understanding
  of conceptual and theoretical elements, in the field of study.
\item
  An understanding and appreciation of current issues and debates in the
  field of study.
\item
  An understanding and appreciation of the philosophical bases,
  methodologies and characteristics of scholarship, research, and
  creative work.
\item
  An understanding of the relevance and value of their contribution to
  the local and global communities' knowledge of fact, theory, and/or
  mastery of practice
\end{enumerate}

\hypertarget{effective-communication}{%
\subsection{Effective communication}\label{effective-communication}}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  A capacity to communicate ideas effectively in suitable formats to a
  range of audiences inside the field of study or discipline and to the
  wider community.
\item
  An ability to communicate effectively using written and spoken English
  and/or Māori, and where appropriate, other languages.
\end{enumerate}

\hypertarget{general-intellectual-skills-and-capacities}{%
\subsection{General intellectual skills and
capacities}\label{general-intellectual-skills-and-capacities}}
...
\item
  A capacity to locate, contextualise, critically evaluate, synthesise,
  and use information effectively.
\item
  An ability to analyse information, where relevant, using appropriate
  tools, technologies, and methods.
\item
  A capacity for critical appraisal of relevant scholarly literature.
\item
  An ability to initiate, design, conduct, sustain, and report research.
\item
  A willingness to seek continuous improvement in research skills and
  quality of research.
\item
  Interdisciplinary perspectives.
\item
  The self-awareness to identify one's professional, personal, and
  research skills, the ability to market these appropriately in the
  employment market.
\item
  An understanding of career and professional development strategies.
\item
  The ability to work independently, as well as collaboratively and
  effectively with others, as appropriate.
\end{enumerate}

\hypertarget{independence-creativity-and-learning}{%
\subsection{Independence, creativity and
learning}\label{independence-creativity-and-learning}}
...
\item
  An ability to identify, define, analyse, and solve problems in a
  flexible manner and the skill to adapt innovatively to changing
  environments and outcomes.
\item
  An appreciation for ideas, discovery, and learning.
\item
  Self discipline and an ability to plan and achieve goals (personal and
  professional), including career advancement and identifying
  appropriate opportunities in the chosen field.
\end{enumerate}

\hypertarget{ethical-and-social-understanding}{%
\subsection{5. Ethical and social
understanding}\label{ethical-and-social-understanding}}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Personal, professional and intellectual integrity, and respect for the
  ethics of research and scholarly activity.
\item
  An awareness of local and global dimensions of intellectual,
  political, and economic activities.
\item
  An appreciation of human and cultural diversity and respect for the
  values of individuals and different cultural groups.
\item
  An awareness of the implications and potential of their research in
...
It was only in 2017 that the \emph{Advanced qualitative research} and
\emph{Advanced qualitative research} courses were introduced to meet
